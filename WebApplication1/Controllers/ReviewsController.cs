...
namespace GameLib.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        public ReviewsController(GameLibContext context)
        {
            _context = context;
        }
        ...
        {
            var gameLibContext = _context.Reviews.Include(r => r.Game).Include(r => r.User);
        ...
        public async Task<IActionResult> Create([Bind("ReviewId,UserId,GameId,Rating,Caption,Date")] Review review)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ReviewId,UserId,GameId,Rating,Caption,Date")] Review review)
        {
